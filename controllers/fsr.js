    ...
    fsr.on('change', function (value) {
      if (value === 1) {
        ...
        if (duration > 10000) {
          ...
          }).form({device_name: config.deviceID, current_location: beacon.getLocationName(beacon.closestBeacon), time_sat_down: timeSat, time_stood_up: timeStood, duration_of_sit: duration, battery_level: battery.voltage, alarm_state: alarm.alarmState})
